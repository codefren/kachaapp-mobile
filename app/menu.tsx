...
const menuItems = [
  ...
  { id: 2, name: 'Recepción de Proveedores', color: '#10b981', category: 'operations' },
  { id: 3, name: 'Control de Temperaturas', color: '#06b6d4', category: 'operations' },
  ...
  { id: 12, name: 'Catálogo de Venta', color: '#ec4899', category: 'commercial' },
...
export default function MenuScreen() {
  ...
  const handleMenuPress = (item: any) => {
    ...
    switch (item.name) {
      case 'Proveedores':
        console.log('[Menu] Caso Proveedores detectado, navegando a /providers');
        router.push('/providers');
        break;
      case 'Recepción de Proveedores':
        console.log('[Menu] Caso Recepción de Proveedores detectado, navegando a /reception');
        router.push('/reception');
        break;
      case 'Dashboard Tienda':
        console.log('[Menu] Caso Dashboard Tienda detectado, navegando a /dashboard');
      ...
      case 'Chat':
        ...
        break;
      default:
        console.log(`[Menu] Función "${item.name}" en desarrollo - no hay caso específico`);
        break;
    }
  };
          ...
          {menuItems.map((item) => (
            ...
            >
              <View style={[styles.iconContainer, { backgroundColor: `${item.color}15` }]}>
                <Text style={[styles.icon, { color: item.color }]}>{getIcon(item.name)}</Text>
              </View>
